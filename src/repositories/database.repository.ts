import {
    HorseRacingEventDocument,
    HorseRacingEventModel
} from '../db/simulatorEvent.schema';
import { IHorseRacingEvent } from '../types/simulator.type';
import { NewEntity } from '../utility/common.type';

const convertHorseRacingEventDocumentToObject = (
    document: HorseRacingEventDocument
) =>
    document.toObject({
        getters: true
...
const save = async (
    simulatorEvent: NewEntity<IHorseRacingEvent>
